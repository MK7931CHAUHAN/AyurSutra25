...
const Profile = () => {
  ...
  /* ---------------- AUTO-SAVE SETTINGS ---------------- */
  const autoSaveSettings = useCallback(async (updatedSettings) => {
    try {
  ...
  /* ---------------- RENDER SETTINGS UI ---------------- */
  const renderSettingsToggle = (category, field, label, description, value) => (
    <div className="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
      ...
      <label className="relative inline-flex items-center cursor-pointer">
        <input 
          ...
          checked={value}
          onChange={(e) => handleSettingsChange(category, field, e.target.checked)}
        />
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-1">
                {renderSettingsToggle(
                  ...
                  settingsForm.notifications.email
                )}
                ...
                {renderSettingsToggle(
                  ...
                  settingsForm.notifications.push
                )}
                ...
                {renderSettingsToggle(
                  ...
                  settingsForm.notifications.marketing
                )}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-1">
                {renderSettingsToggle(
                  ...
                  settingsForm.privacy.profileVisible
                )}
                ...
                {renderSettingsToggle(
                  ...
                  settingsForm.privacy.showEmail
                )}
                ...
                {renderSettingsToggle(
                  ...
                  settingsForm.privacy.showPhone
                )}
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6" data-aos="fade-up">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Auto-save indicator for settings */}
            {activeTab !== "profile" && autoSaveTimer && (
