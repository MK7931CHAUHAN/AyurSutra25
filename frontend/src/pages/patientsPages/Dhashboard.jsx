...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-teal-50 p-4 md:p-6 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4" data-aos="fade-down">
         ...
         <div className="flex flex-wrap gap-3">
            <button
              ...
              className="cursor-pointer hidden px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors duration-200  items-center gap-2 shadow-md hover:shadow-lg"
            >
            ...
            <button
              ...
              className="cursor-pointer hidden px-4 py-2 border border-teal-600 text-teal-600 rounded-lg hover:bg-teal-50 transition-colors duration-200 items-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* ChatBot Window */}
      {showChatBot && (
        <div className="fixed cursor-pointer bottom-20 right-6 w-100 h-150 bg-white rounded-lg shadow-2xl border border-gray-200 z-50 overflow-hidden">
